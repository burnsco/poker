defmodule PokerBackend.AccountsFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `PokerBackend.Accounts` context.
  """
  ...
  def generate_user_magic_link_token(user) do
    ...
    PokerBackend.Repo.insert!(user_token)
