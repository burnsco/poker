defmodule PokerBackendWeb.UserAuth do
  use PokerBackendWeb, :verified_routes
  ...
  @remember_me_cookie "_poker_backend_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      PokerBackendWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  @doc """
  Logs the user out for JSON API.
  """
